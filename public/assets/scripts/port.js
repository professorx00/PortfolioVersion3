$(document).ready(function () {
  let demo = $("<a>").attr("href", "https://warm-dusk-48851.herokuapp.com/").text("Demo ");
  let code = $("<a>").attr("href", "https://github.com/professorx00/CriticalCode").text(" Code");
  $("#links").append(demo).append(code)
  function getDataInfo(num) {
    switch (true) {
      case (num === "1"):
        ...
        $("#links").empty()
        demo = $("<a>").attr("href", "https://warm-dusk-48851.herokuapp.com/").text("Demo ");
        code = $("<a>").attr("href", "https://github.com/professorx00/CriticalCode").text(" Code");
        $("#links").append(demo).append(code)
        break;
      case (num === "2"):
        ...
        $("#links").empty()
        demo = $("<a>").attr("href", "https://whispering-taiga-49037.herokuapp.com/").text("Demo ");
        code = $("<a>").attr("href", "https://github.com/professorx00/BurgerApp").text(" Code");
        $("#links").append(demo).append(code)
        break;
      case (num === "3"):
        ...
        $("#links").empty()
        demo = $("<a>").attr("href", "https://professorx00.github.io/QuizGame/").text("Demo ");
        code = $("<a>").attr("href", "https://github.com/professorx00/QuizGame").text(" Code");
        $("#links").append(demo).append(code)
        break;
      case (num === "4"):
        ...
        $("#links").empty()
        demo = $("<a>").attr("href", "https://cbc-nutrition.web.app/").text("Demo ");
        code = $("<a>").attr("href", "https://github.com/professorx00/NEWT-Application").text(" Code");
        $("#links").append(demo).append(code)
        break;
      case (num === "5"):
        ...
        $("#links").empty()
        demo = $("<a>").attr("href", "https://agile-headland-24805.herokuapp.com/").text("Demo ");
        code = $("<a>").attr("href", "https://github.com/professorx00/FriendFinder2").text(" Code");
        $("#links").append(demo).append(code)
        break;
      case (num === "6"):
        ...
        $("#links").empty()
        demo = $("<a>").attr("href", "https://professorx00.github.io/What-Movie/").text("Demo ");
        code = $("<a>").attr("href", "https://github.com/professorx00/What-Movie").text(" Code");
        $("#links").append(demo).append(code)
        break;
      case (num === "7"):
        ...
        $("#links").empty()
        demo = $("<a>").attr("href", "https://professorx00.github.io/RockPaperScissorsLizardSpock/").text("Demo ");
        code = $("<a>").attr("href", "https://github.com/professorx00/RockPaperScissorsLizardSpock").text(" Code");
        $("#links").append(demo).append(code)
        break;
      case (num === "8"):
        ...
        $("#links").empty()
        demo = $("<a>").attr("href", "https://traintimelogger.web.app/").text("Demo ");
        code = $("<a>").attr("href", "https://github.com/professorx00/Train-Tracker-Logger").text(" Code");
        $("#links").append(demo).append(code)
        break;
      case (num === "9"):
        ...
        $("#links").empty()
        demo = $("<a>").attr("href", "https://professorx00.github.io/Gif-Retreiver/").text("Demo ");
        code = $("<a>").attr("href", "https://github.com/professorx00/Gif-Retreiver").text(" Code");
        $("#links").append(demo).append(code)
        break;
      case (num === "10"):
        ...
        $("#links").empty()
        demo = $("<a>").attr("href", "https://professorx00.github.io/Smash_Brother_Fighter_Clicker/").text("Demo ");
        code = $("<a>").attr("href", "https://github.com/professorx00/Smash_Brother_Fighter_Clicker").text(" Code");
        $("#links").append(demo).append(code)
        break;
    }
  }
